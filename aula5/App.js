...
function CadastrodeContato({ navigation, route }) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.container_inputs}>
        <TextInput style={styles.input} placeholder="Nome" onChangeText={setNovoNome} />
        <TextInput style={styles.input} placeholder="Telefone" onChangeText={setNovoTelefone} />
        <TextInput style={styles.input} placeholder="Email" onChangeText={setNovoEmail} />
